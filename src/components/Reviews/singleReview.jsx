...
/* This function is what is setting the colors in an array then in the array it for each star it calls 
    ...
    return (
        <div className='singleReview'>
            ...
            <div className='singleReview_starsContainer'>
                    <div className='single_star' id="single_star1">
                ...
                <div className='reviewHelpful'>
                    <p className='reviewHelpful_title'> Was this review helpful to you? </p>
                     <div className='thumbsContainer'>
                        <div className='thumbsUp' onClick={handleClick}>
                            ...
                            <p className='numberOfHelpfuls'> 0 </p>   
                        </div>
                        <div className='thumbsDown' onClick={handleClick}>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                        ...
                        <div className='reviewHelpful_flag'>
                        <div className='reviewHelpful_flag_image'> 
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6">
                                <path fillRule="evenodd" d="M3 2.25a.75.75 0 01.75.75v.54l1.838-.46a9.75 9.75 0 016.725.738l.108.054a8.25 8.25 0 005.58.652l3.109-.732a.75.75 0 01.917.81 47.784 47.784 0 00.005 10.337.75.75 0 01-.574.812l-3.114.733a9.75 9.75 0 01-6.594-.77l-.108-.054a8.25 8.25 0 00-5.69-.625l-2.202.55V21a.75.75 0 01-1.5 0V3A.75.75 0 013 2.25z" clipRule="evenodd" />
                            </svg>
                        </div>
                        <p className='reviewHelpful_flag_text'> 
                            Flag this review
                        </p>
                    </div>
                     </div>
